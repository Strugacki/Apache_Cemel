...
public class DefaultOrderService implements OrderService {
   ...
   public String processCreateOrderMessage(Long id) throws Exception {
	   ...
	   log.info("ENTITY: " + orderEntity.getOrderNumber());
   ...
   private com.pluralsight.orderfulfillment.generated.Order buildOrderXmlType(OrderEntity orderEntity) throws Exception{
	com.pluralsight.orderfulfillment.generated.ObjectFactory objectFactory = new com.pluralsight.orderfulfillment.generated.ObjectFactory();
	...
	orderType.setFulfillemntCenter(FulfillmentCenter.ABC_FULFILLEMNT_CENTER);
	orderType.setOrderNumber(orderEntity.getOrderNumber());
	GregorianCalendar cal = new GregorianCalendar();
	cal.setTime(orderEntity.getTimeOrderPlaced());
